    ...
    <div class="d-block side-panel pt-4">
        ...
        <div class="card">
            ...
            <div class="card-header text-success p-3 pt-4">
                ...
                <h1 class="modal-title fs-6 m-0 p-0 d-inline-block">Tranding_Github_Repo</h1>
            ...
            <div class="card-body text-success p-3">
                ...
                <div class="d-block text-start mb-3">
                    <label class="form-label mb-2 text-success">Search Keyword</label>
                    <input 
                    v-model="widget_data.widget_data.keyword" 
                    @input="update_widget()" 
                    type="text" 
                    class="form-control" 
                    placeholder="Topic: Search term">
                </div>

                <div class="d-block text-end mb-3">
                    <GenericButton @click="reload_list()" label="Search" />
                </div>
